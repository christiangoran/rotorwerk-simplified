...
export default function Contact() {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8" id="contact">
      ...
      >
        <div
          className="mt-1 relative left-1/2 z-[-10] aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#32402C] to-[#96A621] opacity-10 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
