          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-700">
                Unsere Mitarbeiter verfügen über langjährige Erfahrung im
                Bereich Technische Dokumentation - sowohl, was die Erstellung
                firmeninterner Arbeitsanleitungen und Checklisten angeht, also
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    (Arbeitsanleitungen, Instruktionen und Protokolle) für den
                    internen Gebrauch
                  </span>
                </li>
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    für Kunden bis hin zum fertigen Layout
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <WrenchIcon
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">
                      Betreuung von interner Firmendokumentation
                    </strong>{" "}
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">
                      Erstellung von Lehrmateria
                    </strong>{" "}
                    und Schulungsunterlagen für Ihre Mitarbeiter bzw. Kunden
                  </span>
                </li>
              </ul>
            </div>
